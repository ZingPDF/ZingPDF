...
namespace ZingPdf.Core.Objects.Filters
{
    ...
    {
        private readonly Ascii85 _ascii85 = new() { EnforceMarks = false };

        public Name Name => "ASCII85Decode";

        public string EndOfDataMarker => _ascii85.SuffixMark;
        ...
        public string Encode(byte[] data)
        {
            ...
            return _ascii85.Encode(data) + _ascii85.SuffixMark;
        }
