...
public class ReadOnlyPdf : IReadOnlyPdf, IDisposable
{
    ...
    public ReadOnlyIndirectObjectDictionary IndirectObjects { get; }
    ...
    private static async Task<IStreamObject<CrossReferenceStreamDictionary>?> GetXrefStreamAsync(Stream pdfStream)
    {
        ...
        if (xrefObject is IndirectObject io
            && io.Children.First() is IStreamObject<CrossReferenceStreamDictionary> so)
