...
public class SmokeTests
{
    ...
    [InlineData(Files.GeneratedImageHeavy)]
    [InlineData(Files.GeneratedIncrementalHistory)]
    [InlineData(Files.GeneratedMixedWorkload)]
    [InlineData(Files.GeneratedTextHeavy)]
