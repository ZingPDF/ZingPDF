...
namespace ZingPDF.Elements.Drawing
{
    public interface ICoordinateTranslator
    {
        ...
        /// If the coordinate system is set top TopDown, apply a vertical translation to the Y coordinates.
        /// </summary>
        Rectangle FlipTextCoordinatesIfRequired(int pageDisplayRotation, double pageWidth, double pageHeight, CoordinateSystem coordinateSystem, Rectangle boundingBox);
