...
internal class FontDictionary : Dictionary
{
    ...
    /// </summary>
    public DictionaryProperty<Name?> BaseFont => Get<Name?>(Constants.DictionaryKeys.Font.BaseFont);
    ...
    /// </summary>
    public DictionaryProperty<Number?> FirstChar => Get<Number?>(Constants.DictionaryKeys.Font.FirstChar);
    ...
    /// </summary>
    public DictionaryProperty<Number?> LastChar => Get<Number?>(Constants.DictionaryKeys.Font.LastChar);
    ...
    /// </summary>
    public DictionaryProperty<ArrayObject?> Widths => Get<ArrayObject?>(Constants.DictionaryKeys.Font.Widths);
    ...
    /// </summary>
    public DictionaryProperty<FontDescriptorDictionary?> FontDescriptor => Get<FontDescriptorDictionary?>(Constants.DictionaryKeys.Font.FontDescriptor);
