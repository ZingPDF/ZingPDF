...
public class Type3FontDictionary : FontDictionary
{
    ...
    private Type3FontDictionary(Dictionary<string, IPdfObject> dictionary, IPdf pdf, ObjectContext context)
        : base(dictionary, pdf, context)
    {
    }

    public Type3FontDictionary(IPdf pdf, ObjectContext context)
        : base(Subtypes.Simple.Type3, pdf, context)
    {
    }
    ...
    /// </para>
    /// </summary>
    public RequiredProperty<Rectangle> FontBBox => GetRequiredProperty<Rectangle>(Constants.DictionaryKeys.Font.Type3.FontBBox);
    ...
    /// </para>
    /// </summary>
    public RequiredProperty<ArrayObject> FontMatrix => GetRequiredProperty<ArrayObject>(Constants.DictionaryKeys.Font.Type3.FontMatrix);
    ...
    /// </summary>
    public RequiredProperty<Dictionary> CharProcs => GetRequiredProperty<Dictionary>(Constants.DictionaryKeys.Font.Type3.CharProcs);
    ...
    public static Type3FontDictionary FromDictionary(Dictionary<string, IPdfObject> dictionary, IPdf pdf, ObjectContext context)
    {
        return new Type3FontDictionary(dictionary, pdf, context);
    }
