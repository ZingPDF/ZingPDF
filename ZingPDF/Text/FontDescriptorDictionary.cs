...
{
    public FontDescriptorDictionary(IPdf pdf, ObjectContext context)
        : base(Constants.DictionaryTypes.FontDescriptor, pdf, context) { }

    public FontDescriptorDictionary(Dictionary dictionary)
        : base(dictionary) { }

    private FontDescriptorDictionary(Dictionary<string, IPdfObject> dictionary, IPdf pdf, ObjectContext context)
    ...
    {
        return new FontDescriptorDictionary(dictionary, pdf, context);
    }
}
