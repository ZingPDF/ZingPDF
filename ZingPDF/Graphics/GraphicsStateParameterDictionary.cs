...
namespace ZingPDF.Graphics
{
    ...
    {
        public GraphicsStateParameterDictionary(IPdf pdf, ObjectContext context)
            : base(Constants.DictionaryTypes.ExtGState, pdf, context) { }

        /// <summary>
        /// (Optional; PDF 1.3) The line width (see 8.4.3.2, "Line width").
        /// </summary>
        public OptionalProperty<Number> LW => GetOptionalProperty<Number>(Constants.DictionaryKeys.GraphicsStateParameter.LW);

        /// <summary>
        ///(Optional; PDF 1.3) The line cap style (see 8.4.3.3, "Line cap style").
        /// </summary>
        public OptionalProperty<Number> LC => GetOptionalProperty<Number>(Constants.DictionaryKeys.GraphicsStateParameter.LC);

        /// <summary>
        /// (Optional; PDF 1.3) The line join style (see 8.4.3.4, "Line join style").
        /// </summary>
        public OptionalProperty<Number> LJ => GetOptionalProperty<Number>(Constants.DictionaryKeys.GraphicsStateParameter.LJ);

        /// <summary>
        /// (Optional; PDF 1.3) The miter limit (see 8.4.3.5, "Miter limit").
        /// </summary>
        public OptionalProperty<Number> ML => GetOptionalProperty<Number>(Constants.DictionaryKeys.GraphicsStateParameter.ML);
        ...
        /// </summary>
        public OptionalProperty<ArrayObject> D => GetOptionalProperty<ArrayObject>(Constants.DictionaryKeys.GraphicsStateParameter.D);

        /// <summary>
        /// (Optional; PDF 1.3) The name of the rendering intent (see 8.6.5.8, "Rendering intents").
        /// </summary>
        public OptionalProperty<Name> RI => GetOptionalProperty<Name>(Constants.DictionaryKeys.GraphicsStateParameter.RI);
        ...
        /// </summary>
        public OptionalProperty<BooleanObject> OP => GetOptionalProperty<BooleanObject>(Constants.DictionaryKeys.GraphicsStateParameter.OP);
        ...
        /// </summary>
        public OptionalProperty<Number> OPM => GetOptionalProperty<Number>(Constants.DictionaryKeys.GraphicsStateParameter.OPM);
        ...
        /// </summary>
        public OptionalProperty<ArrayObject> Font => GetOptionalProperty<ArrayObject>(Constants.DictionaryKeys.GraphicsStateParameter.Font);
        ...
        /// </summary>
        public OptionalProperty<IPdfObject> BG => GetOptionalProperty<IPdfObject>(Constants.DictionaryKeys.GraphicsStateParameter.BG);
        ...
        /// </summary>
        public OptionalProperty<IPdfObject> BG2 => GetOptionalProperty<IPdfObject>(Constants.DictionaryKeys.GraphicsStateParameter.BG2);
        ...
        /// </summary>
        public OptionalProperty<IPdfObject> UCR => GetOptionalProperty<IPdfObject>(Constants.DictionaryKeys.GraphicsStateParameter.UCR);
        ...
        /// </summary>
        public OptionalProperty<IPdfObject> UCR2 => GetOptionalProperty<IPdfObject>(Constants.DictionaryKeys.GraphicsStateParameter.UCR);
        ...
        /// </summary>
        public OptionalProperty<IPdfObject> TR => GetOptionalProperty<IPdfObject>(Constants.DictionaryKeys.GraphicsStateParameter.TR);
        ...
        /// </summary>
        public OptionalProperty<IPdfObject> TR2 => GetOptionalProperty<IPdfObject>(Constants.DictionaryKeys.GraphicsStateParameter.TR2);
        ...
        /// </summary>
        public OptionalProperty<IPdfObject> HT => GetOptionalProperty<IPdfObject>(Constants.DictionaryKeys.GraphicsStateParameter.HT);

        /// <summary>
        /// (Optional; PDF 1.3) The flatness tolerance (see 10.7.2, "Flatness tolerance").
        /// </summary>
        public OptionalProperty<Number> FL => GetOptionalProperty<Number>(Constants.DictionaryKeys.GraphicsStateParameter.FL);

        /// <summary>
        /// (Optional; PDF 1.3) The smoothness tolerance (see 10.7.3, "Smoothness tolerance").
        /// </summary>
        public OptionalProperty<Number> SM => GetOptionalProperty<Number>(Constants.DictionaryKeys.GraphicsStateParameter.SM);

        /// <summary>
        /// (Optional) A flag specifying whether to apply automatic stroke adjustment (see 10.7.5, "Automatic stroke adjustment").
        /// </summary>
        public OptionalProperty<BooleanObject> SA => GetOptionalProperty<BooleanObject>(Constants.DictionaryKeys.GraphicsStateParameter.SA);
        ...
        /// </summary>
        public OptionalProperty<IPdfObject> BM => GetOptionalProperty<IPdfObject>(Constants.DictionaryKeys.GraphicsStateParameter.BM);
        ...
        /// </summary>
        public OptionalProperty<IPdfObject> SMask => GetOptionalProperty<IPdfObject>(Constants.DictionaryKeys.GraphicsStateParameter.SMask);
        ...
        /// </summary>
        public OptionalProperty<Number> CA => GetOptionalProperty<Number>(Constants.DictionaryKeys.GraphicsStateParameter.CA);
        ...
        /// </summary>
        public OptionalProperty<BooleanObject> AIS => GetOptionalProperty<BooleanObject>(Constants.DictionaryKeys.GraphicsStateParameter.AIS);
        ...
        /// </summary>
        public OptionalProperty<BooleanObject> TK => GetOptionalProperty<BooleanObject>(Constants.DictionaryKeys.GraphicsStateParameter.TK);
        ...
        /// </summary>
        public OptionalProperty<Name> UseBlackPtComp => GetOptionalProperty<Name>(Constants.DictionaryKeys.GraphicsStateParameter.UseBlackPtComp);
    }
}
