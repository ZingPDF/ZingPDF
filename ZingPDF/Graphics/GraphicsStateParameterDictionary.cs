...
namespace ZingPDF.Graphics
{
    internal class GraphicsStateParameterDictionary : Dictionary
    {
        ...
        /// </summary>
        public AsyncProperty<ArrayObject>? D => Get<ArrayObject>(Constants.DictionaryKeys.GraphicsStateParameter.D);

        /// <summary>
        /// (Optional; PDF 1.3) The name of the rendering intent (see 8.6.5.8, "Rendering intents").
        /// </summary>
        public AsyncProperty<Name>? RI => Get<Name>(Constants.DictionaryKeys.GraphicsStateParameter.RI);
        ...
        /// </summary>
        public AsyncProperty<BooleanObject>? OP => Get<BooleanObject>(Constants.DictionaryKeys.GraphicsStateParameter.OP);
        ...
        /// </summary>
        public AsyncProperty<ArrayObject>? Font => Get<ArrayObject>(Constants.DictionaryKeys.GraphicsStateParameter.Font);
        ...
        /// </summary>
        public AsyncProperty<IPdfObject>? BG => Get<IPdfObject>(Constants.DictionaryKeys.GraphicsStateParameter.BG);
        ...
        /// </summary>
        public AsyncProperty<IPdfObject>? BG2 => Get<IPdfObject>(Constants.DictionaryKeys.GraphicsStateParameter.BG2);
        ...
        /// </summary>
        public AsyncProperty<IPdfObject>? UCR => Get<IPdfObject>(Constants.DictionaryKeys.GraphicsStateParameter.UCR);
        ...
        /// </summary>
        public AsyncProperty<IPdfObject>? UCR2 => Get<IPdfObject>(Constants.DictionaryKeys.GraphicsStateParameter.UCR);
        ...
        /// </summary>
        public AsyncProperty<IPdfObject>? TR => Get<IPdfObject>(Constants.DictionaryKeys.GraphicsStateParameter.TR);
        ...
        /// </summary>
        public AsyncProperty<IPdfObject>? TR2 => Get<IPdfObject>(Constants.DictionaryKeys.GraphicsStateParameter.TR2);
        ...
        /// </summary>
        public AsyncProperty<IPdfObject>? HT => Get<IPdfObject>(Constants.DictionaryKeys.GraphicsStateParameter.HT);
        ...
        /// </summary>
        public AsyncProperty<BooleanObject>? SA => Get<BooleanObject>(Constants.DictionaryKeys.GraphicsStateParameter.SA);
        ...
        /// </summary>
        public AsyncProperty<IPdfObject>? BM => Get<IPdfObject>(Constants.DictionaryKeys.GraphicsStateParameter.BM);
        ...
        /// </summary>
        public AsyncProperty<IPdfObject>? SMask => Get<IPdfObject>(Constants.DictionaryKeys.GraphicsStateParameter.SMask);
        ...
        /// </summary>
        public AsyncProperty<BooleanObject>? AIS => Get<BooleanObject>(Constants.DictionaryKeys.GraphicsStateParameter.AIS);
        ...
        /// </summary>
        public AsyncProperty<BooleanObject>? TK => Get<BooleanObject>(Constants.DictionaryKeys.GraphicsStateParameter.TK);
        ...
        /// </summary>
        public AsyncProperty<Name>? UseBlackPtComp => Get<Name>(Constants.DictionaryKeys.GraphicsStateParameter.UseBlackPtComp);
    }
}
