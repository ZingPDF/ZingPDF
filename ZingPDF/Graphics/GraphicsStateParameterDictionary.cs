...
namespace ZingPDF.Graphics
{
    internal class GraphicsStateParameterDictionary : Dictionary
    {
        ...
        /// </summary>
        public DictionaryProperty<Number?> LW => Get<Number?>(Constants.DictionaryKeys.GraphicsStateParameter.LW);

        /// <summary>
        ///(Optional; PDF 1.3) The line cap style (see 8.4.3.3, "Line cap style").
        /// </summary>
        public DictionaryProperty<Number?> LC => Get<Number?>(Constants.DictionaryKeys.GraphicsStateParameter.LC);

        /// <summary>
        /// (Optional; PDF 1.3) The line join style (see 8.4.3.4, "Line join style").
        /// </summary>
        public DictionaryProperty<Number?> LJ => Get<Number?>(Constants.DictionaryKeys.GraphicsStateParameter.LJ);

        /// <summary>
        /// (Optional; PDF 1.3) The miter limit (see 8.4.3.5, "Miter limit").
        /// </summary>
        public DictionaryProperty<Number?> ML => Get<Number?>(Constants.DictionaryKeys.GraphicsStateParameter.ML);
        ...
        /// </summary>
        public DictionaryProperty<ArrayObject?> D => Get<ArrayObject?>(Constants.DictionaryKeys.GraphicsStateParameter.D);

        /// <summary>
        /// (Optional; PDF 1.3) The name of the rendering intent (see 8.6.5.8, "Rendering intents").
        /// </summary>
        public DictionaryProperty<Name?> RI => Get<Name?>(Constants.DictionaryKeys.GraphicsStateParameter.RI);
        ...
        /// </summary>
        public DictionaryProperty<BooleanObject?> OP => Get<BooleanObject?>(Constants.DictionaryKeys.GraphicsStateParameter.OP);
        ...
        /// </summary>
        public DictionaryProperty<Number?> OPM => Get<Number?>(Constants.DictionaryKeys.GraphicsStateParameter.OPM);
        ...
        /// </summary>
        public DictionaryProperty<ArrayObject?> Font => Get<ArrayObject?>(Constants.DictionaryKeys.GraphicsStateParameter.Font);
        ...
        /// </summary>
        public DictionaryProperty<IPdfObject?> BG => Get<IPdfObject?>(Constants.DictionaryKeys.GraphicsStateParameter.BG);
        ...
        /// </summary>
        public DictionaryProperty<IPdfObject?> BG2 => Get<IPdfObject?>(Constants.DictionaryKeys.GraphicsStateParameter.BG2);
        ...
        /// </summary>
        public DictionaryProperty<IPdfObject?> UCR => Get<IPdfObject?>(Constants.DictionaryKeys.GraphicsStateParameter.UCR);
        ...
        /// </summary>
        public DictionaryProperty<IPdfObject?> UCR2 => Get<IPdfObject?>(Constants.DictionaryKeys.GraphicsStateParameter.UCR);
        ...
        /// </summary>
        public DictionaryProperty<IPdfObject?> TR => Get<IPdfObject?>(Constants.DictionaryKeys.GraphicsStateParameter.TR);
        ...
        /// </summary>
        public DictionaryProperty<IPdfObject?> TR2 => Get<IPdfObject?>(Constants.DictionaryKeys.GraphicsStateParameter.TR2);
        ...
        /// </summary>
        public DictionaryProperty<IPdfObject?> HT => Get<IPdfObject?>(Constants.DictionaryKeys.GraphicsStateParameter.HT);

        /// <summary>
        /// (Optional; PDF 1.3) The flatness tolerance (see 10.7.2, "Flatness tolerance").
        /// </summary>
        public DictionaryProperty<Number?> FL => Get<Number?>(Constants.DictionaryKeys.GraphicsStateParameter.FL);

        /// <summary>
        /// (Optional; PDF 1.3) The smoothness tolerance (see 10.7.3, "Smoothness tolerance").
        /// </summary>
        public DictionaryProperty<Number?> SM => Get<Number?>(Constants.DictionaryKeys.GraphicsStateParameter.SM);

        /// <summary>
        /// (Optional) A flag specifying whether to apply automatic stroke adjustment (see 10.7.5, "Automatic stroke adjustment").
        /// </summary>
        public DictionaryProperty<BooleanObject?> SA => Get<BooleanObject?>(Constants.DictionaryKeys.GraphicsStateParameter.SA);
        ...
        /// </summary>
        public DictionaryProperty<IPdfObject?> BM => Get<IPdfObject?>(Constants.DictionaryKeys.GraphicsStateParameter.BM);
        ...
        /// </summary>
        public DictionaryProperty<IPdfObject?> SMask => Get<IPdfObject?>(Constants.DictionaryKeys.GraphicsStateParameter.SMask);
        ...
        /// </summary>
        public DictionaryProperty<Number?> CA => Get<Number?>(Constants.DictionaryKeys.GraphicsStateParameter.CA);
        ...
        /// </summary>
        public DictionaryProperty<BooleanObject?> AIS => Get<BooleanObject?>(Constants.DictionaryKeys.GraphicsStateParameter.AIS);
        ...
        /// </summary>
        public DictionaryProperty<BooleanObject?> TK => Get<BooleanObject?>(Constants.DictionaryKeys.GraphicsStateParameter.TK);
        ...
        /// </summary>
        public DictionaryProperty<Name?> UseBlackPtComp => Get<Name?>(Constants.DictionaryKeys.GraphicsStateParameter.UseBlackPtComp);
    }
}
