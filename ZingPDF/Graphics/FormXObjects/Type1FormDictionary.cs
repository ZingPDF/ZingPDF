...
namespace ZingPDF.Graphics.FormXObjects
{
    ...
    internal class Type1FormDictionary : FormDictionary
    {
        ...
        /// </summary>
        public AsyncProperty<Rectangle> BBox => Get<Rectangle>(Constants.DictionaryKeys.Form.Type1.BBox)!;
        ...
        /// </summary>
        public AsyncProperty<ArrayObject>? Matrix => Get<ArrayObject>(Constants.DictionaryKeys.Form.Type1.Matrix);
        ...
        /// </summary>
        public AsyncProperty<ResourceDictionary>? Resources => Get<ResourceDictionary>(Constants.DictionaryKeys.Form.Type1.Resources);
        ...
        /// </summary>
        public AsyncProperty<Dictionary>? Group => Get<Dictionary>(Constants.DictionaryKeys.Form.Type1.Group);
        ...
        /// </summary>
        public AsyncProperty<Dictionary>? Ref => Get<Dictionary>(Constants.DictionaryKeys.Form.Type1.Ref);

        /// <summary>
        /// (Optional; PDF 1.4) A metadata stream containing metadata for the form XObject (see 14.3.2, "Metadata streams").
        /// </summary>
        public AsyncProperty<StreamObject<MetadataStreamDictionary>>? Metadata => Get<StreamObject<MetadataStreamDictionary>>(Constants.DictionaryKeys.Form.Type1.Metadata);
        ...
        /// </summary>
        public AsyncProperty<Dictionary>? PieceInfo => Get<Dictionary>(Constants.DictionaryKeys.Form.Type1.PieceInfo);
        ...
        /// </summary>
        public AsyncProperty<Date>? LastModified => Get<Date>(Constants.DictionaryKeys.Form.Type1.LastModified);
        ...
        /// </summary>
        public AsyncProperty<Dictionary>? OPI => Get<Dictionary>(Constants.DictionaryKeys.Form.Type1.OPI);
        ...
        /// </summary>
        public AsyncProperty<Dictionary>? OC => Get<Dictionary>(Constants.DictionaryKeys.Form.Type1.OC);
        ...
        /// </summary>
        public AsyncProperty<Name>? Name => Get<Name>(Constants.DictionaryKeys.Form.Type1.Name);
        ...
        /// </summary>
        public AsyncProperty<ArrayObject>? AF => Get<ArrayObject>(Constants.DictionaryKeys.Form.Type1.AF);
