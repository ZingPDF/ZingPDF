...
namespace ZingPDF.Forms
{
    ...
    internal class InteractiveFormDictionary : Dictionary
    {
        ...
        /// </summary>
        public ArrayObject Fields { get => Get<ArrayObject>(DictionaryKeys.Fields)!; }
        ...
        /// </summary>
        public BooleanObject? NeedAppearances { get => Get<BooleanObject>(DictionaryKeys.NeedAppearances); }
        ...
        /// Default value: 0.
        /// </summary>
        public Integer? SigFlags { get => Get<Integer>(DictionaryKeys.SigFlags); }
        ...
        /// </summary>
        public ArrayObject? CO { get => Get<ArrayObject>(DictionaryKeys.CO); }
        ...
        /// </summary>
        public IPdfObject? XFA { get => Get<IPdfObject>(DictionaryKeys.XFA); }
