...
namespace ZingPDF.Syntax.FileStructure.ObjectStreams
{
    internal class ObjectStreamDictionary : StreamDictionary
    {
        ...
        private ObjectStreamDictionary(Dictionary<string, IPdfObject> objectStreamDictionary, IPdf pdf, ObjectContext context)
            : base(objectStreamDictionary, pdf, context) { }
        ...
        new public static ObjectStreamDictionary FromDictionary(Dictionary<string, IPdfObject> objectStreamDictionary, IPdf pdf, ObjectContext context)
        {
            ...
            return new(objectStreamDictionary, pdf, context);
        }
    }
}
