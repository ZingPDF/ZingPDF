...
namespace ZingPDF.Syntax.Functions.Type0
{
    ...
    internal class Type0FunctionDictionary : StreamFunctionDictionary
    {
        ...
        /// </summary>
        public ArrayObject Size => Get<ArrayObject>(Constants.DictionaryKeys.Function.Type0.Size)!;
        ...
        /// </summary>
        public Integer BitsPerSample => Get<Integer>(Constants.DictionaryKeys.Function.Type0.BitsPerSample)!;
        ...
        /// Default value: 1.
        /// </summary>
        public Integer? Order => Get<Integer>(Constants.DictionaryKeys.Function.Type0.Order);
        ...
        /// </summary>
        public ArrayObject? Encode => Get<ArrayObject>(Constants.DictionaryKeys.Function.Type0.Encode);
        ...
        /// </summary>
        public ArrayObject? Decode => Get<ArrayObject>(Constants.DictionaryKeys.Function.Type0.Decode);
    }
}
