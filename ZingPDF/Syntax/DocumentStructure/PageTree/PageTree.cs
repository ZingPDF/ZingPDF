...
public class PageTree
{
    ...
    public async Task<PageTreeNodeDictionary> GetRootPageTreeNodeAsync() => (PageTreeNodeDictionary)(await _rootPageTreeNode).Object;
    ...
    public async Task<int> GetPageCountAsync() => (await GetRootPageTreeNodeAsync()).PageCount;
